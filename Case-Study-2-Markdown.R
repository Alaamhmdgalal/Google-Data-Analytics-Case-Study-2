---
title: "Google-Data-Analtics-Case-Study-2"
author: "Alaa Mohamed"
date: "10/16/2024"
...
```{r}
write.csv(combined_data,"C:\\Users\\hp\\OneDrive\\Documents\\fitbit\\combined_data.csv", row.names = FALSE)
```

Import filtered dataset back into R.

```{r}
combined_data_sleep_activity_df <- read_csv("combined_data.csv")
```
